...
class Monitor:
    ...
    def print_notification(self, datetime, id, value, name_param, model):
        ...
        print("")
        print("")
    def print_alarma_medicamento(self, datetime, id, value, name_param, model):
        print("  ---------------------------------------------------")
        print("    ADVERTENCIA")
        print("  ---------------------------------------------------")
        print("    Es hora de que tome el " + str(name_param) + " (" + str(value) + ")" + " a las " + str(self.format_datetime(datetime)) + " el adulto mayor que utiliza el dispositivo " + str(model) + ":" + str(id))
        print("")
        print("")
